...
class StructurePDB:
    ...
    def make_3D_structure_plot(self, atom_id='CA', coloring=None):
        ...
        return fig  #FIXME: give ax to plot on
    ...
    def make_contact_map(self, atom_id='CA', cutoff=10):
        ...
        return fig, dist_matrix  #FIXME: give ax to plot on
...
if __name__ == "__main__":
    ...
    parser = PDBParser()
    structure = parser.get_structure("Consensus", "JuisteConsensus.pdb")
    ...
    fig, dist_matrix = struct.make_contact_map(cutoff=8)


    fig.savefig('MyContactMap.pdf')

    np.savetxt('Distance_AA_consensus.txt', dist_matrix)
